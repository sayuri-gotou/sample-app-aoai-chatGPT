...
logger.addHandler(AzureLogHandler(connection_string=os.environ.get("InstrumentationKey=440a07c4-5f60-46c2-955e-f24ec9874c84;IngestionEndpoint=https://canadaeast-0.in.applicationinsights.azure.com/")))
